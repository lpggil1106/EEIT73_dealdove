...
$(document).ready(()=>{
    ...
    const ecpayRadio = document.getElementById('ecpayment'); // 获取绿界支付的 radio button
    const payButtonCash = document.getElementById('payButtonCash');
    const payButtonEcpay = document.getElementById('payButtonEcpay');
